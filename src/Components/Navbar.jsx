...
export const Navbar = () => {
  ...
  return (
    <>
      <div className="py-2 sm:px-6 bg-gray-100 flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-20">
        <button
          type="button"
        ...
        <ul className="ml-auto flex items-center">
            ...
            >
              <form action="" className="p-4 border-b border-b-gray-100">
                <div className="relative w-full">
                  <input
                    type="text"
                    className="py-2 pr-4 pl-10 bg-gray-50 w-full outline-none border border-gray-100 rounded-md text-sm focus:border-indigo-500"
                    placeholder="Search..."
                  />
          ...
          <li className="relative">
            ...
            >
              <div className="flex items-center px-4 pt-4 border-b border-b-gray-100 notification-tab">
                <span className="text-gray-400 font-medium text-[13px] hover:text-gray-600 border-b-2 border-b-transparent mr-4 pb-1 active">
                  Notifications
                </span>
              </div>
              <div className="my-2">
                ...
                >
                  <li>
                    ...
                    >
                      ...
                      />
                      <div className="ml-2">
                        <div className="text-[13px] text-gray-600 font-medium truncate group-hover:text-indigo-500">
                          Exiting News Waiting for you
                        </div>
          ...
          <li className="relative ml-3">
            ...
            <ul className="shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-white border border-gray-100 w-full max-w-[140px]">
              <li>
                <a
                  href="#"
